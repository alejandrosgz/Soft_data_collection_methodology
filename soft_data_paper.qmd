...
![Study area location, lithology, permeability and selected basins.](Figures/Studied_basinss.png){#fig-location}
...
complete_data <- gauging_data_tagus %>% filter(cod %in% cods, year(date) %in% 2010:2018) %>%
   ...
   ndays < ndays ~ paste("No, ", ndays-ndays, " days missing", sep = "")))
