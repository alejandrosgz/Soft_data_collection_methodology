...
Both datasets were analysed with graphical and statistical methods to ensure its reliability. In the case of the streamflow, the availability of enough available data was proved and it can be found in Appendix I. Those gauging stations with enough data were used to select the studied subbasins according to the criteria explained in section 3.2.
